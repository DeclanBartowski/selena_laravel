...
class PlatformProvider extends OrchidServiceProvider
{
    ...
    {
        return [
            Menu::make(__('platform.social.name'))
                ->icon('monitor')
                ->route('platform.social.list')
                ->title(__('platform.entity.office')),
            ...
            Menu::make(__('platform.advantage.name'))
                ->icon('monitor')
                ->route('platform.advantage.list'),
            Menu::make(__('platform.text_block.name'))
                ->icon('monitor')
                ->route('platform.text_block.list'),
            ...
            Menu::make(__('platform.meta_fields.name'))
                ->icon('monitor')
                ->route('platform.meta_field.list'),
            Menu::make(__('platform.page.name'))
                ->icon('monitor')
                ->route('platform.page.list'),
            Menu::make(__('platform.setting.name'))
                ->icon('monitor')
